...
Viber requires a specific **User ID** (Receiver ID) to send messages to a user. This is *not* your phone number. To get your User ID:
...
```
*(Wrangler will prompt you to enter the copied values securely)*
