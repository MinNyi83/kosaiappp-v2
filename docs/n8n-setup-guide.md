...
Because n8n is running _inside_ an isolated Docker container, it does not know what `localhost` or `127.0.0.1` means in the context of your host machine (where Cloudflare Wrangler is running).
