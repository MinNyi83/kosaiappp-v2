...
* **Voice Transcription**: 
  ...
  * Sends the audio (`audio/ogg`) to Gemini `gemini-2.5-flash` with the prompt: *"Transcribe this spoken technical issue or service complaint into plain English text. Do not summarize, output only the transcribed text."*
